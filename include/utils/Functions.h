...
inline double calculate_tof(const T1 &t1, const T2 &t2) {
   /*!
	 ...
	 * \returns <c>t1 - t2</c> if both parameters are valid; otherwise: \c exotic::DR_NO_DATA
	 */
...
inline double calculate_sum(T begin, T end) {
   /*!
	 * Example:
	 * \code
	 * double anodes = { 300., 200., 100., 1., 0., -1. }; // exotic::DR_NO_DATA == -1
...
class Isort {
 ...
 public:
   Isort(T begin, Order compare_) : values(begin), compare(compare_) {}
...
class IsortLess {
 ...
 public:
   IsortLess(T begin) : values(begin) {}
   bool operator()(int index1, int index2) {
 ...
 * \endcode
 *
 * \note Any values initially set to exotic::DR_NO_DATA are left untouched
 */
template <class T, class L, class V>
 ...
 * \code
 * double array[] = { 1, 2, 3, 4, 5 };
 * double mean = exotic::utils::mean(array, array + 5);
 * std::cout << "mean is " << mean << ", stddev is "
 *           << exotic::utils::calculate_stddev(array, array + 5, mean) << "\n";
 * \endcode
 */
template <class InputIterator>
typename std::iterator_traits<InputIterator>::value_type
 ...
 * \code
 * double array[] = { 1, 2, 3, 4, 5 };
 * std::cout << "stddev is " << exotic::utils::calculate_stddev(array, array + 5) << "\n";
 * \endcode
 */
template <class InputIterator>
typename std::iterator_traits<InputIterator>::value_type
calculate_stddev(InputIterator first, InputIterator last) {
   const typename std::iterator_traits<InputIterator>::value_type mean =
       exotic::utils::calculate_mean(first, last);
   return exotic::utils::calculate_stddev(first, last, mean);
}
 ...
 * std::cout "The name of the file is: " << exotic_UTILS_STRINGIFY(A_MACRO) << "\n";
 * \endcode
 *
 * Result: "The name of the file is filename.txt"
 */
#define EXOTIC_UTILS_STRINGIFY(S) EXOTIC_UTILS_STRINGIFY_HELPER(S)

/// Helper macro for exotic_UTILS_STRINGIFY
#define EXOTIC_UTILS_STRINGIFY_HELPER(S) #S

#else

#pragma link C++ function exotic::utils::calculate_mean(Double_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_weighted_mean(Double_t *, Double_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_stddev(Double_t *, Double_t *);

#pragma link C++ function exotic::utils::calculate_mean(Float_t *, Float_t *);
#pragma link C++ function exotic::utils::calculate_weighted_mean(Float_t *, Float_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_stddev(Float_t *, Float_t *);

#pragma link C++ function exotic::utils::calculate_mean(Long64_t *, Long64_t *);
#pragma link C++ function exotic::utils::calculate_weighted_mean(Long64_t *, Long64_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_stddev(Long64_t *, Long64_t *);

#pragma link C++ function exotic::utils::calculate_mean(Long_t *, Long_t *);
#pragma link C++ function exotic::utils::calculate_weighted_mean(Long_t *, Long_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_stddev(Long_t *, Long_t *);

#pragma link C++ function exotic::utils::calculate_mean(Int_t *, Int_t *);
#pragma link C++ function exotic::utils::calculate_weighted_mean(Int_t *, Int_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_stddev(Int_t *, Int_t *);

#pragma link C++ function exotic::utils::calculate_mean(Short_t *, Short_t *);
#pragma link C++ function exotic::utils::calculate_weighted_mean(Short_t *, Short_t *, Double_t *);
#pragma link C++ function exotic::utils::calculate_stddev(Short_t *, Short_t *);
